...
namespace CPRG200_Workshop2_Group5
{
    public partial class frmModifyPackage : Form
    {
        ...
        private void frmModifyPackage_Load_1(object sender, EventArgs e)
        {
        ...
        //SAVE UPDATE
        private void btnSaveMod_Click_1(object sender, EventArgs e)
        {
            //VALIDATE
            //if(IsValidData())
            ...
            try
            {
                if (!PackageDB.UpdatePackage(package, newPackage)) //returned false
                {
        ...
        private void btnExit4_Click_1(object sender, EventArgs e)
        {
            this.Close();
        }
    }
